...
// Build 53 weeks × 7 days grid going back 12 months from today
...
// Get month labels for the heatmap x-axis
...
export default function DashboardClient({ totalEntries, streak, moodCounts, heatmapMap, today }: Props) {
    ...
    <div className="container py-4" style={{ maxWidth: '900px' }}>
      ...
      <div className="rounded-3 p-4 mb-4" style={{ border: '1px solid var(--color-border)', backgroundColor: 'var(--color-bg)', overflowX: 'auto' }}>
        <h6 className="fw-semibold mb-3" style={{ color: 'var(--color-text-primary)' }}>
          Entries over the last 12 months
        </h6>
              ...
              {DAYS.map((day, i) => (
                <div
                  ...
                  style={{
                    ...
                    color: 'var(--color-text-muted)',
                    lineHeight: '11px',
                    visibility: i % 2 === 0 ? 'visible' : 'hidden', // show every other day
                  }}
                >
                  {day}
                </div>
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        outline: isToday ? '2px solid var(--color-text-primary)' : 'none',
